                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-md-3 col-sm-6">
                                <div className="single-shop-product">
                                    <div className="product-upper">
                                        <img src="public/BT6/telephone_shop_template/img/product-2.jpg" alt="Sản phẩm 2" />
                                    </div>
                                    <h2>
                            ...
                            <div className="col-md-3 col-sm-6">
                                <div className="single-shop-product">
                                    <div className="product-upper">
                                        <img src="public/BT6/telephone_shop_template/img/product-1.jpg" alt="" />
                                    </div>
                                    <h2>
                                        <a href="">Apple new mac book 2015 March :P</a>
                                    </h2>
                            ...
                            <div className="col-md-3 col-sm-6">
                                <div className="single-shop-product">
                                    <div className="product-upper">
                                        <img src="public/BT6/telephone_shop_template/img/product-3.jpg" alt="" />
                                    </div>
                                    <h2>
                                        <a href="">Apple new mac book 2015 March :P</a>
                                    </h2>
                            ...
                            <div className="col-md-3 col-sm-6">
                                <div className="single-shop-product">
                                    <div className="product-upper">
                                        <img src="public/BT6/telephone_shop_template/img/product-4.jpg" alt="" />
                                    </div>
                                    <h2>
                                        <a href="">Apple new mac book 2015 March :P</a>
                                    </h2>
                            ...
                            <div className="col-md-3 col-sm-6">
                                <div className="single-shop-product">
                                    <div className="product-upper">
                                        <img src="public/BT6/telephone_shop_template/img/product-2.jpg" alt="" />
                                    </div>
                                    <h2>
                                        <a href="">Apple new mac book 2015 March :P</a>
                                    </h2>
